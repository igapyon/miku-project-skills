...
description: miku-project Node.js / Java runtime の help surface を miku-soft 標準へ近付ける依頼。
topics: [miku-project, cli, upstream, help]
...
対象: `miku-project` Node.js CLI と `miku-project-java` CLI。
...
[`help-compatibility.json`](../skills/igapyon-miku-project/references/runtime/help-compatibility.json) と
